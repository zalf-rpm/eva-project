...
# TODO: Überprüfen, ob hier in die richtige Einheit umgerechnet wird - AKP: war falsch, korregiert (29.10.2013)
modell_nmin_0_30 = smout$"N0-30"
modell_nmin_30_60 = smout$"N30-60"
modell_nmin_60_90 = smout$"N60-90"
modell_nmin_90_120 = smout$"N90-120"
modell_nmin_0_90 = smout$"N0-90"
...
if (calc_nconc == 1) {
  ...
  rsquare_yield_n = calc_rsquare(p = modell_yield_n_values, o=mean_yield_n) #added by AKP 06/02/14
  ...
  rsquare_n_uptake = calc_rsquare(p = modell_n_uptake_values, o=mean_n_uptake) #added by AKP 07/02/14
  ...
  rsquare_n_zeiternte = calc_rsquare(p = modell_n_zeiternten_values, o=n_zeiternte) #added by AKP 07/02/14
...
if (calc_ertrag == 1) {
  ...
  rsquare_ertrag = calc_rsquare(p = modell_ertrag, o=avg_messertrag) #added by AKP 06/02/14
  ...
  rsquare_zwischenernte = calc_rsquare(p = modell_zwischenernte, o=mean_zwischenernte) #added by AKP 07/02/14
...
if (calc_soilnmin == 1) {
  ...
  rsquare_nmin30 = calc_rsquare(p = modell_nmin_0_30_values, o=nmin30) #added by AKP 07/02/14
  ...
  rsquare_nmin60 = calc_rsquare(p = modell_nmin_30_60_values, o=nmin60) #added by AKP 07/02/14
  ...
  nmseu_nmin90 = 1-nmses_nmin90
  rsquare_nmin90 = calc_rsquare(p = modell_nmin_60_90_values, o=nmin90) #added by AKP 07/02/14
  ...
  rsquare_nmin1_3 = calc_rsquare(p = sum_nmin_modell, o=sum_nmin) #added by AKP 07/02/14
...
if (calc_height == 1) {
  ...
  rsquare_height = calc_rsquare(p = modell_height_values, o=height) #added by AKP 07/02/14
...
if (calc_bedgrad == 1) {
  ...
  rsquare_bedgrad = calc_rsquare(p = modell_bedgrad_values, o=bedgrad) #added by AKP 07/02/14
...
if (calc_soilmoisture == 1) {
  ...
  rsquare_moisture30 = calc_rsquare(p = modell_moisture_0_30_values, o=moisture30) #added by AKP 07/02/14
  ...
  rsquare_moisture60 = calc_rsquare(p = modell_moisture_30_60_values, o=moisture60) #added by AKP 07/02/14
  ...
  rsquare_moisture90 = calc_rsquare(p = modell_moisture_60_90_values, o=moisture90) #added by AKP 07/02/14
  ...
  rsquare_moisture1_3 = calc_rsquare(p = sum_moisture_modell, o=sum_moisture) #added by AKP 07/02/14
...
if (calc_wasser_v4 == 1) {
  ...
  nmseu_moisture30 = 1-nmses_moisture30
  rsquare_moisture30 = calc_rsquare(p = modell_moisture_30_values, o=moisture30) #added by AKP 07/02/14
  sample_size_moisture30 = length(moisture30)
  ...
  nmseu_moisture60 = 1-nmses_moisture60
  rsquare_moisture60 = calc_rsquare(p = modell_moisture_60_values, o=moisture60) #added by AKP 07/02/14
  sample_size_moisture60 = length(moisture60)
  ...
  nmseu_moisture90 = 1-nmses_moisture90
  rsquare_moisture90 = calc_rsquare(p = modell_moisture_90_values, o=moisture90) #added by AKP 07/02/14
  sample_size_moisture90 = length(moisture90)
  ...
  nmseu_moisture1_3 = 1-nmses_moisture1_3
  rsquare_moisture1_3 = calc_rsquare(p = modell_moisture1_3, o=moisture1_3) #added by AKP 07/02/14
 ...
 if (calc_bodtemp == 1) {
   ...
   rsquare_bodtemp5 = calc_rsquare(p = modell_bodtemp5_values, o=bodtemp5) #added by AKP 07/02/14
   ...
   rsquare_bodtemp20 = calc_rsquare(p = modell_bodtemp20_values, o=bodtemp20) #added by AKP 07/02/14
...
if (calc_ertrag == 1) {
  ...
  text(legend_date,12000, labels=paste("MBE:   ",round(mbe_ertrag,2)), adj=0,col="black", cex=0.9 )
  ...
  text(legend_date, 4500, labels=paste("R2:  ", round(rsquare_ertrag,4)), adj=0,col="dark green", cex=0.9)
}
legend(legend_date, max_y,inset=c(0.01,0.02), c("Modell Ertrag", "Modell Ob. Biom.", "Messwert Endernte", "Messwert Zwischenernte","Duengung"), pch=c("_","_","o","o","_"), col=c("red","darkgrey","red","darkgrey", "darkgrey"))
par(xpd=FALSE)
...
par(xpd=TRUE)
legend(legend_date2, max_y,inset=c(0.01,0.02), c("Transpiration-Defizit","N-Defizit", "Duengung", "Entw.-stadium"), pch=c("_","_","_","_"), col=c("slateblue1","firebrick4","darkgrey", "grey"))
par(xpd=FALSE)

max_y = 8
# Entwicklungsstadien
print("Plot Entwicklungsstadien")
plot(modell_datum,modell_dev_stage, type="l", col="black",main="Entwicklungsstadium", xlab="Datum", ylab="Entwicklungsstadien", ylim=c(0,max_y))
...
par(xpd=TRUE)
legend(legend_date2, max_y,inset=c(0.01,0.02), c("Entw.-Stad.","Duengung", "Messpunkte"), pch=c("_","_","o"), col=c("black","darkgrey","red"))
par(xpd=FALSE)
...
print("Plot Höhe")
max_y=4
plot(modell_datum,modell_height,col="red",main="Bestandeshoehe", xlab="Datum", ylab="Hoehe [m]", ylim=c(0,max_y), type="l", cex=1.0)
...
if (calc_height == 1) {
  ...
  text(legend_date,0, labels=paste("R2:  ", round(rsquare_height,4)), adj=0,col="dark green", cex=0.9)
}
legend(legend_date, max_y,inset=c(0.01,0.02), c("Modell","Messpunkte", "Duengung"), pch=c("_","o","_"), col=c("red", "black", "darkgrey"))
par(xpd=FALSE)
...
par(xpd=FALSE)
legend(legend_date2, max_y,inset=c(0.01,0.02), c("N Conc","Duengung"), pch=c("_","_"), col=c("red", "darkgrey"))



if (calc_nconc == 1) {
  text(legend_date2,0.16, labels=paste("MBE:   ",round(mbe_yield_n,4)), adj=0,col="black", cex=0.9 )
  text(legend_date2,0.13, labels=paste("MAE:    ",round(mae_yield_n,4)), adj=0,col="black", cex=0.9 )
  text(legend_date2,0.1, labels=paste("nMAE:  ",round(nmae_yield_n,4)), adj=0,col="black", cex=0.9 )
  text(legend_date2,0.07, labels=paste("EF:  ",round(ef_yield_n,4)), adj=0,col="black", cex=0.9 )
  text(legend_date2,0.04, labels=paste("IOA:  ",round(ioa_yield_n,4)), adj=0,col="black", cex=0.9 )
  text(legend_date2,0.01, labels=paste("R2:   ", round(rsquare_yield_n,4)), adj=0,col="dark green", cex=0.9 )  #added by AKP 06/02/14
...
par(xpd=FALSE)
legend(legend_date2, max_y,inset=c(0.01,0.02), c("N Ob. Biomasse","Duengung"), pch=c("_","_"), col=c("red", "darkgrey"))
if (calc_nconc == 1) {
  ...
  text(legend_date2,50, labels=paste("R2:  ", round(rsquare_n_uptake,4)), adj=0,col="dark green", cex=0.9)
}
...
if (calc_soilmoisture == 1 | calc_wasser_v4==1) {
  ...
  text(legend_date,2, labels=paste("R2:  ", round(rsquare_moisture30,4)), adj=0,col="dark green", cex=0.9)
}
...
par(xpd=FALSE)
if (calc_soilnmin == 1) {
  text(legend_date,120, labels=paste("MBE:   ",round(mbe_nmin30,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,100, labels=paste("MAE:    ",round(mae_nmin30,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,80, labels=paste("nMAE:  ",round(nmae_nmin30,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,60, labels=paste("EF:    ",round(ef_nmin30,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,40, labels=paste("IOA:  ",round(ioa_nmin30,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,20, labels=paste("R2:  ", round(rsquare_nmin30,4)), adj=0,col="dark green", cex=0.9)
}
legend(legend_date, max_y,inset=c(0.01,0.02), c("Modell", "Messpunkte", "Duengung"), pch=c("_","o","_"), col=c("red", "black", "darkgrey"))
par(xpd=TRUE)
...
if (calc_soilmoisture == 1 | calc_wasser_v4==1) {
  ...
  text(legend_date,2, labels=paste("R2:  ", round(rsquare_moisture60,4)), adj=0,col="dark green", cex=0.9)
}
legend(legend_date, max_y,inset=c(0.01,0.02), c("Modell", "Messpunkte"), pch=c("_","o"), col=c("red", "black"))
par(xpd=TRUE)
...
par(xpd=FALSE)
if (calc_soilnmin == 1) {
  text(legend_date,120, labels=paste("MBE:   ",round(mbe_nmin60,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,100, labels=paste("MAE:    ",round(mae_nmin60,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,80, labels=paste("nMAE:  ",round(nmae_nmin60,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,60, labels=paste("EF:    ",round(ef_nmin60,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,40, labels=paste("IOA:  ",round(ioa_nmin60,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,20, labels=paste("R2:  ", round(rsquare_nmin60,4)), adj=0,col="dark green", cex=0.9)
}
legend(legend_date, max_y,inset=c(0.01,0.02), c("Modell", "Messpunkte", "Duengung"), pch=c("_","o","_"), col=c("red", "black", "darkgrey"))
par(xpd=TRUE)
}
...
if (calc_soilmoisture == 1 | calc_wasser_v4==1) {
  ...
  text(legend_date,2, labels=paste("R2:  ", round(rsquare_moisture90,4)), adj=0,col="dark green", cex=0.9)
}
legend(legend_date, max_y,inset=c(0.01,0.02), c("Modell", "Messpunkte"), pch=c("_","o"), col=c("red", "black"))
par(xpd=TRUE)
...
par(xpd=FALSE)
if (calc_soilnmin == 1) {
  text(legend_date,120, labels=paste("MBE:   ",round(mbe_nmin1_3,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,100, labels=paste("MAE:    ",round(mae_nmin1_3,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,80, labels=paste("nMAE:  ",round(nmae_nmin1_3,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,60, labels=paste("EF:    ",round(ef_nmin1_3,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,40, labels=paste("IOA:  ",round(ioa_nmin1_3,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,20, labels=paste("R2:  ", round(rsquare_nmin1_3,4)), adj=0,col="dark green", cex=0.9)
}
legend(legend_date, max_y,inset=c(0.01,0.02), c("Modell", "Messpunkte", "Duengung"), pch=c("_","o","_"), col=c("red", "black", "darkgrey"))
par(xpd=TRUE)
...
par(xpd=TRUE)
if (calc_bodtemp  == 1) {
  text(legend_date,17, labels=paste("MBE:   ",round(mbe_bodtemp5,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,14, labels=paste("MAE:    ",round(mae_bodtemp5,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,11, labels=paste("nMAE:  ",round(nmae_bodtemp5,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,8, labels=paste("EF:    ",round(ef_bodtemp5,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,5, labels=paste("IOA:  ",round(ioa_bodtemp5,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,2, labels=paste("R2:  ", round(rsquare_bodtemp5,4)), adj=0,col="dark green", cex=0.9)
}
legend(legend_date, max_y,inset=c(0.01,0.02), c("Modell", "Messpunkte"), pch=c("_","o"), col=c("red", "black"))
par(xpd=TRUE)
...
max_y = bodtemp_max
plot(modell_datum, modell_bodtemp20,col="red",main="Bodentemperatur 20cm", xlab="Datum", ylab=" [°C]", ylim=c(0,max_y), type="l", cex=1.0)
grid(col="lightgrey")
...
par(xpd=TRUE)
if (calc_bodtemp == 1) {
  text(legend_date,17, labels=paste("MBE:   ",round(mbe_bodtemp20,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,14, labels=paste("MAE:    ",round(mae_bodtemp20,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,11, labels=paste("nMAE:  ",round(nmae_bodtemp20,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,8, labels=paste("EF:    ",round(ef_bodtemp20,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,5, labels=paste("IOA:  ",round(ioa_bodtemp20,2)), adj=0,col="black", cex=0.9 )
  text(legend_date,2, labels=paste("R2:  ", round(rsquare_bodtemp20,4)), adj=0,col="dark green", cex=0.9)
}
legend(legend_date, max_y,inset=c(0.01,0.02), c("Modell", "Messpunkte"), pch=c("_","o"), col=c("red", "black"))
par(xpd=TRUE)
...
par(xpd=TRUE)
legend(legend_date2, max_y,inset=c(0.01,0.02), c("Modell leaching N", "Duengung", "Ob. Biomasse"), pch=c("_","_","_"), col=c("red", "darkgrey","darkgrey"))
par(xpd=TRUE)
...
cat("", "Size", "MBE", "MAE", "nMAE", "RSME", "nMSEs", "nMSEu", "IoA", "EF", "R2", "\n",  file=filename, sep=";", append=FALSE)
