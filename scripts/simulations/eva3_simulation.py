...
sys.path.append(os.path.normpath("D:/development/monica/monica-swig"))
...
simulation_output_dir = os.path.normpath("d:/Eigene Dateien prescher/monica_simulations/runs")
